...
require.config({
    ...
    paths: {
        ...
        'im': 'plugin/im/js/im',//im服务
        'strophe': 'plugin/im/js/sdk/strophe-1.2.5.min',//im 依赖
        'easemob': 'plugin/im/js/sdk/easemob.im-1.1',//im 依赖
        'easemob_shim': 'plugin/im/js/sdk/easemob.im-1.1.shim',//,im 老版本sdk依赖
        'im.base':'plugin/im/js/im.base',
        'swfobject':'js/public/swfobject'
    },
    shim: {
        'swfobject':{
            exports:'swfobject'
